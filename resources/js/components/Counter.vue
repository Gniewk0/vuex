<template>
    <div class="m-auto">
        <h6 class="d-flex justify-content-center text-light">Coal mained</h6>
        <div>
            <h2 class="d-flex justify-content-center text-light">{{ count.toFixed(2) }}</h2>
        </div>
       <div class="d-flex justify-content-center">
           <button class="btn btn-secondary" @click="increment"><svg class="bi bi-minecart-loaded" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
